...
<div class="register-box" style="width:600px;background-color: white;margin: 5% auto;">
    ...
    <form action="/update_admin/{{$rid}}" method="post" id="form">
            ...
            <div class="col-xs-6">  
                <div class="form-group">
                    <select class="form-control select2" name="role" style="width: 100%;" >
                                    <option value="{{$role_type->role_id}}">{{$role_type->role_type}}</option>
                     </select>
                </div>         
            </div>
            <div class="col-xs-6">
                <div class="form-group">
                    <select class="form-control select2" name="campuse" style="width: 100%;" >
                        <option selected="selected" value="{{$data->camp_name}}" disabled>{{$data->camp_name}}</option>
                        @if(count($camp) > 0)
